 ...
 * @version $Revision$
  */
public class ReportDocument implements PropertyAccessor, ListenToXmlWrite, XmlWriteListener {
    static {
    ...
    private static void collectComponentVariables(Component comp, VariableContext vm2) {
