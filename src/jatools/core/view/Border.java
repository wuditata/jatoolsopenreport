...
public class Border implements Serializable, PropertyAccessor, BorderBase {
    ...
    */
     ...
     * @return DOCUMENT ME!
     */
    public static Stroke getSolidStroke(final int width) {
     ...
     * @return DOCUMENT ME!
     */
    public static Stroke getDashedStroke(final int width) {
     ...
     * @return DOCUMENT ME!
     */
    public static Stroke getDottedStroke(final int width) {
        return new BasicStroke(width, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10.0f,
            new float[] {
                2
            }, 0);
