...
class BorderSelectionPanel extends JPanel implements BorderWorker {
    ...
    */
    ...
    void build() {
        ...
        commandPanel.add(new JLabel("粗细:"), c);
        ...
        c.gridwidth = 1;
        commandPanel.add(new JLabel("线型: "), c);
        c.weightx = 0;
        c.gridwidth = GridBagConstraints.REMAINDER;
        ...
        commandPanel.add(new JLabel("颜色:"), c);
    ...
    private JPanel createTableBorderButtonsPanel() {
        ...
        Icon25x25Button button = new Icon25x25Button(new BorderAction("清除所有边框",
        ...
        button = new Icon25x25Button(lastAction = new BorderAction("全部边框",
        ...
        button = new Icon25x25Button(new BorderAction("左边框",
        ...
        button = new Icon25x25Button(new BorderAction("中边框",
        ...
        button = new Icon25x25Button(new BorderAction("右边框",
        ...
        p.add(button, c);
        c.gridwidth = GridBagConstraints.REMAINDER;
        button = new Icon25x25Button(new BorderAction("框架",
        ...
        button = new Icon25x25Button(new BorderAction("上边框",
        ...
        button = new Icon25x25Button(new BorderAction("下边框",
        ...
        button = new Icon25x25Button(new BorderAction("十字边框",
