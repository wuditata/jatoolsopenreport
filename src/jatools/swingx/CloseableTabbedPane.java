...
public class CloseableTabbedPane extends JTabbedPane implements MouseListener, MouseMotionListener {
        ...
        if (headerViewport == null) {
            for (int i = 0; i < this.getComponentCount(); i++) {
                ...
                if (c instanceof JViewport) {
                    ...
                    headerViewport.getView().addMouseListener(CloseableTabbedPane.this);
                    headerViewport.getView().addMouseMotionListener(CloseableTabbedPane.this);
    ...
    private void processMouseEvents(MouseEvent e) {
        ...
        if (this.headerViewport != null) {
            x -= this.headerViewport.getViewPosition().x;
        }
        ...
        ((JComponent) this.headerViewport.getView()).setToolTipText(this.getToolTipTextAt(tabNumber));
