...
public class ZImageFileChooser {
    ...
    public static ZImageFileChooser getSharedInstance(Component owner) {
        if (sharedInstance == null) {
            sharedInstance = new ZImageFileChooser(owner);
        }
...
class ImagePreview extends JPanel implements PropertyChangeListener {
    ...
    JRadioButton asLink;
    ZImageViewer viewer = new ZImageViewer();
...
class ImageFilter extends javax.swing.filechooser.FileFilter {
    ...
    public boolean accept(File f) {
        ...
        String extension = ZImageFileChooser.getExtension(f);

        if (extension != null) {
            if (extension.equals(ZImageFileChooser.tiff) ||
                    extension.equals(ZImageFileChooser.tif) ||
                    extension.equals(ZImageFileChooser.gif) ||
                    extension.equals(ZImageFileChooser.jpeg) ||
                    extension.equals(ZImageFileChooser.jpg)) {
                return true;
            } else {
                return false;
            }
...
class ImageFileView extends FileView {
    ...
    public String getTypeDescription(File f) {
        ...
        if (extension != null) {
            if (extension.equals(ZImageFileChooser.jpeg) ||
                    extension.equals(ZImageFileChooser.jpg)) {
                type = "JPEG Image"; //
            } else if (extension.equals(ZImageFileChooser.gif)) {
                type = "GIF Image"; //
            } else if (extension.equals(ZImageFileChooser.tiff) ||
                    extension.equals(ZImageFileChooser.tif)) {
                type = "TIFF Image"; //
            }
        }
