...
public class Cell implements Comparable, PropertyAccessor, Cloneable {
    ...
    */
     ...
     *
     * @param object 另一个ZCell 或 _Component
     *
    ...
    /* (non-Javadoc)
     * @see com.jatools.core.accessor.ZPropertyAccessor#onLoad(org.w3c.dom.Element)
     */
