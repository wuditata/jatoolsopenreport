...
public abstract class TableBase extends Component implements GridComponent {
     ...
     * DOCUMENT ME!
     *
     * @param columnkeyExpressions DOCUMENT ME!
     */
     ...
     * DOCUMENT ME!
     *
     * @param rowkeyExpressions DOCUMENT ME!
     */
     ...
     * DOCUMENT ME!
     *
     * @param columnWidths DOCUMENT ME!
     */
    ...
    public Cell getCellAt(int x, int y) {
        ...
        Cell cell = getCellstore().getCell(row, column);
    ...
    private void removeEmptyCell(ArrayList children) {
        for (Iterator iter = children.iterator(); iter.hasNext();) {
            ...
            if (com instanceof Label) {
                ...
                if (Main.getInstance()!=null && nullString(label.getText()) && nullString(label.getName()) &&
