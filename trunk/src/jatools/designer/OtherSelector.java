...
public class OtherSelector extends javax.swing.JPanel {
    ...
    public void initGUI() {
        try {
            ...
            tableMode = new JCheckBox("选择表格模式");
            ...
            jPanel2.add(jPanel3);
            onHeader.setText("在页眉显示");
            onHeader.setVisible(true);
            jPanel3.add(onHeader);
            onFooter.setText("在页脚显示");
