 ...
 * @version $Revision$
  */
public class _Variable implements Transferable, ProtectPublic {
    public static DataFlavor thisFlavor = new DataFlavor(_Variable.class, "class");
     ...
     */
    public _Variable(String displayName, int permission, String variableName) {
     ...
     */
    public _Variable(String displayName, int permission, String variableName, Object var) {
        this.displayName = displayName;
        this.variableName = variableName;
        this.permission = permission;
        this.variable = var;
     ...
     * @param permission DOCUMENT ME!
     */
    public _Variable(String displayName, int permission) {
    ...
    public boolean equals(Object another) {
        if (another instanceof _Variable) {
            _Variable an = (_Variable) another;
