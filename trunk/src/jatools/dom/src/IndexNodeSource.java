...
public class IndexNodeSource extends NodeSource {
    ...
    public PropertyDescriptor[] getRegistrableProperties() {
        return new PropertyDescriptor[] {
            ...
            new PropertyDescriptor("TagName", String.class, PropertyDescriptor.SERIALIZABLE), new PropertyDescriptor("KeyExpression", String.class, PropertyDescriptor.SERIALIZABLE)
        };
    }
    ...
    */
    public Node create(Node parent, Script script) {
        ...
        if ((this.indexFields != null) && (indexFields.length > 0)) {
            ...
            IndexView indexView = new IndexView(ds,((DatasetBasedNode) parent).getRowSet() ,ds.getRowInfo().getIndexByColumnName( this.indexFields ));
            IndexNode result = new IndexNode((DatasetBasedNode) parent, this.getTagName(),
            		indexView);
